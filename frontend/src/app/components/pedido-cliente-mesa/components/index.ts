/**
 * Sub-componentes do PedidoClienteMesa
 *
 * Componentes extraídos para reduzir o tamanho do componente principal
 * seguindo as regras do cursor (max 300 linhas por arquivo).
 */
