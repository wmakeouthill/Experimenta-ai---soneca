 ...
 * 
 * IMPORTANTE: Esta configuração SÓ é ativada com o profile "cloud".
 * - Cloud Run: SPRING_PROFILES_ACTIVE=prod,cloud
 * - VPS (Docker Compose): SPRING_PROFILES_ACTIVE=prod (usa DataSource padrão do
 * Spring Boot)
 */
@Configuration
@Profile("cloud")
public class CloudSqlDataSourceConfig {
    ...
    public DataSource dataSource() {
        ...
        try {
            ...
            throw new RuntimeException(
                    "Cloud SQL Socket Factory não encontrado no classpath. " +
                            ...
                            "está incluída no pom.xml e no JAR final.",
                    e);
        }
        ...
        // Garantir que cloudSqlInstance está na URL ou extrair e adicionar como
        // propriedade
