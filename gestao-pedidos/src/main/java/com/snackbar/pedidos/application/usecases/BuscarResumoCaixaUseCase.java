 ...
 * Busca vendas em dinheiro diretamente dos pedidos e sangrias/suprimentos da tabela de caixa.
 */
@Service
...
public class BuscarResumoCaixaUseCase {
    ...
    private List<ItemCaixaDTO> extrairVendasEmDinheiro(List<Pedido> pedidos) {
        ...
        for (Pedido pedido : pedidos) {
            if (pedido.getMeiosPagamento() == null) continue;
    ...
    /**
     * Calcula a diferença global somando as diferenças de todas as sessões fechadas.
     */
